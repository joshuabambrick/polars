...
cat_series = pl.Series(["Polar", "Panda", "Brown", "Brown", "Polar"], =dtype)
...
dtype = pl.Enum(["Polar", "Panda", "Brown"])
try:
    cat_series = pl.Series(["Polar", "Panda", "Brown", "Black"], =dtype)
...
# --8<-- [start:equality]
dtype = pl.Enum(["Polar", "Panda", "Brown"])
cat_series = pl.Series(["Brown", "Panda", "Polar"], =dtype)
cat_series2 = pl.Series(["Polar", "Panda", "Brown"], =dtype)
...
cat_series = pl.Series(["Low", "Medium", "High"], =dtype)
...
dtype = pl.Enum(["Low", "Medium", "High"])
cat_series = pl.Series(["Low", "Medium", "High"], =dtype)
cat_series2 = pl.Series(["High", "High", "Low"], =dtype)
print(cat_series <= cat_series2)
